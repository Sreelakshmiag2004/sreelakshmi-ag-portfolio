          ...
          >
            {skillsData.map((skill, index) => (
              <motion.div
                ...
                className="card-cosmic text-center group"
              >
                <div 
                  className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-glow transition-all duration-300 group-hover:shadow-glow-intense"
